...
CREATE TABLE `room` (
  ...
  PRIMARY KEY (`type`,`floorNum`,`buildingNum`)
...
INSERT INTO `room` VALUES ('Catering Room',4,1),('Costume Room',2,1),('Green Room',1,1),('Lighting Room',3,1),('Makeup Room',2,1),('Office',5,1),('Prop Room',4,1),('Rehearsal Room',1,1),('Sound Room',3,1),('Storage Room',5,1);
